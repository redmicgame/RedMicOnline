    ...
    const allCerts = useMemo(() => {
        ...
        if (gameState.onlineAlbums) {
            gameState.onlineAlbums.forEach(album => {
                ...
                // However, online_albums_v6 might not have songIds. But if the game computes pure sales directly from `album.allTimeSales` we could use that. Let's do a fallback:
